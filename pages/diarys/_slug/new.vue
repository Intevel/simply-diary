<template>
  <div>
    ...
    <div class="px-4 py-8 mt-4 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-16" @submit.prevent="createNewEntry">
      <div class="max-w-screen-lg sm:mx-auto">
        <form class="col-lg-12 text-start mt-5">
          <label class="block">
            ...
            <textarea v-model="entry" class="form-textarea mt-1 mb-3 block w-full border-2 border-simplydiarynew-primary rounded border-opacity-50 focus:border-simplydiarynew-secondary focus:outline-none focus:shadow-outline" rows="12"
