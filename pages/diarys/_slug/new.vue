<template>
  <div>
    ...
    <div class="px-4 py-8 mt-4 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-16"
        ...
        <form class="col-lg-12 text-start mt-5">
          <label class="block">
            ...
            <textarea v-model="entry"
              ...
              rows="12" placeholder="Today I saw my dream girl again...." required></textarea>
            <button type="submit"
  ...
  export default Vue.extend({
    ...
    methods: {
      async createNewEntry() {
        var createdDiaryPost = await this.$axios.post("https://api.simply-diary.xyz/v1/diarys/" + this.$nuxt
          .context
          .params
          .slug + "/posts", {
            content: this.entry
